// Check to see if we need to convert from LaTeX to mathjs string.
// LaTeX has '\', '{', and '}' characters while expressions generally shouldn't:
...
module.exports = { isTex, texToMath };